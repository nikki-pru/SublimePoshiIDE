...
class PoshiTagCompletions(sublime_plugin.EventListener):
    """
    Provide tag completions for Poshi
    ...
    def default_completion_list(self):
        """
        Generate a default completion list for Poshi
        """
        default_list = []
        normal_tags = ([
            'command','execute', 'function', 'locator1', 'macro', 'value', 'value1', 'var'
        ])
        ...
        default_list += ([
            ...
            ('br\tTag', 'br>'),
            ('col\tTag', 'col>'),
            ('com\tTag, command name=\"$1\">\n</command>')
            ('comnp\tTag, command name=\"$1\" priority=\"$2\">\n</command>')
            ('exf\tTag, execute function=\"$1\" locator1=\"$2\" value1=\"$3\" />')
            ('exm\tTag, execute macro=\"$1\">\n\t<var name=\"$2\" value=\"$3\" />\n</execute>')
            ('hr\tTag', 'hr>'),
